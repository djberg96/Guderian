...
RSpec.describe Map::SmolenskData do
  describe ".apply!" do
    it "applies the entered terrain, river, road, and railroad data for rows 01 and 02" do
      ...
      expect(Hex.find_by!(hex_number: "3430").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3431").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3529").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3531").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3628").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3629").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3630").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3631").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3729").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "3731").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "4028").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "4131").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "4328").terrain_type).to eq("forest")
      expect(Hex.find_by!(hex_number: "4427").terrain_type).to eq("forest")
